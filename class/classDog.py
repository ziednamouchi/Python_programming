...
# does this automatically for us but we have to have "self" as the first parameter to the __init__ method (i.e. the constructor).
...
#This is an accessor method that returns the speakText stored in theobject. 
